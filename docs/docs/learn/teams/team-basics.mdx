...
- [Advanced Teams](./advanced-teams.mdx) - Complex team patterns
- [Team Workflows](./team-workflows.mdx) - Structured team processes
- [Team Monitoring](../advanced/team-monitoring.mdx) - Performance tracking 